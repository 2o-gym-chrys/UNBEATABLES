...
Θα φτιάξουμε qr code με ένα ανοιχτό λογισμικό QR code generator, που όταν το σκανάρεις θα παραπέμπει σε κάποιο ανοιχτό-δωρεάν βιβλίο ή σε επιλογές για βιβλία –κόμικ –ποιήματα. Openbook.gr
...
Με αγάλματα, αγγεία κτλ κομψή διακόσμηση και περιβάλλον που θυμίζει αίθουσα μουσείου. Θα φτιάξουμε qr code με ένα ανοιχτό λογισμικό QR code generator, που όταν το σκανάρεις θα παραπέμπει σε φωτογραφίες από αρχαιολογικά μουσεία της Ελλάδας. Θα ήταν ιδανικό για τους τουρίστες που επισκέπτονται τη χώρα μας.
...
Θα φτιάξουμε qr code με ένα ανοιχτό λογισμικό QR code generator, που όταν το σκανάρεις θα παραπέμπει στο στον ήρωα και θα μπορούν να δουν πληροφορίες για το κόμικ ή να το διαβάσουν online κάποιο τεύχος.
