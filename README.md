...
**Το συνολικό κόστος και για τις 13 ιδέες μας, με όλα τα υλικά που χρειάζονται, εκτιμάται γύρω στα 258 ευρώ.**

Επειδή όμως πολλά από τα στοιχεία που χρειαζόμαστε επαναλαμβάνονται, για να μπορέσουμε εμείς να τα φτιάξουμε και να τα παρουσιάσουμε όλα, θα χρειαστούμε και ζητάμε από εσάς μόνο τα παρακάτω υλικά :
...
Αυτές είναι οι ιδέες και οι προτάσεις μας και δεσμευόμαστε ότι θα έχουμε έτοιμες τουλάχιστον 10 από τις 13.
