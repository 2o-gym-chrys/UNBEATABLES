...
**Παρακάτω θα διαβάσετε την παρουσίαση που κάναμε για την πρώτη φάση του διαγωνισμού, ενώ στους αριθμημένους φακέλους των UNBEATABLES (1-13) θα διαβάσετε και θα δείτε αναλυτικά τις τελικές προτάσεις μας.Οι εκπαιδευτικοί στόχοι που θέσαμε επιτεύχθηκαν στο έπακρο.**
