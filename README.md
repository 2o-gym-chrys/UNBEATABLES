...
Επειδή όμως πολλά από τα στοιχεία που χρειαζόμαστε επαναλαμβάνονται, για να μπορέσουμε εμείς να τα φτιάξουμε και να τα παρουσιάσουμε όλα, θα χρειαστούμε μόνο τα παρακάτω υλικά :
