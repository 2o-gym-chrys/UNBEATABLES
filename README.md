...
Πολλά από τα στοιχεία που χρειαζόμαστε επαναλαμβάνονται.

Για να μπορέσουμε εμείς να τα φτιάξουμε και να τα παρουσιάσουμε όλα, θα χρειαστούμε μόνο τα παρακάτω υλικά :
